...
| 4 | Canonical desktop shortcut is OneDrive Desktop only. | No second shortcut location. No host path is published. | Operator GO, this session. No separate gate file in this packet. |
